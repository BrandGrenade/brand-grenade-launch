...
import { ArrowLeft, Check, Circle, Loader2, Upload, X, FileText } from "lucide-react";
...
type InputMap = Record<SectionKey, string>;
...
function IntelligenceNewPage() {
  ...
  async function handleFilesAdded(key: SectionKey, list: FileList | File[]) {
    ...
    // Preflight: reject unknown extensions and oversized individual files.
    ...
    // Register placeholder rows immediately.
    ...
    // Extract sequentially so we don't blow the main thread.
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Block if any files are still processing.
    ...
    // Build file metadata array for the DB.
