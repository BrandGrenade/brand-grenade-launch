...
Output ONLY the propositions, then the ranking, then the recommendation. Do NOT write any preamble, framing paragraph, methodology note, acknowledgement of the brief, commentary on what you detected or rewrote, or any explanation of how the propositions were derived. Do not reference grievance, the category's wrongs, or the Emotional Direction Test in the output. Do NOT wrap a preface inside a "## The Single-Minded Propositions" heading or any other heading — headings are not a loophole. The VERY FIRST CHARACTERS of your response must be the first numbered proposition (e.g. "### One —" or "### 1." or "**1.**"). No title heading. No section heading. No paragraph before the first proposition. No clarifying note. No "before the propositions". No apology, no permission, no reward, no deserve, no earned, no guilt, no "without apology", no "permission to" — these words and phrases are banned everywhere in the output including in proposition rationales, ranking commentary, and recommendation. The reader must not be able to tell a rewrite occurred.
