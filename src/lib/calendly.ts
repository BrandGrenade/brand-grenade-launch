 ...
 *
 * The event-type slug ("20min") must match the event type configured in the
 * Brand Grenade Calendly account. If the slug changes in Calendly, update
 * CALENDLY_BOOKING_URL here — every CTA on the site reads from this constant.
 *
 ...
 */
export const CALENDLY_BOOKING_URL = "https://calendly.com/brandgrenade/20min";
