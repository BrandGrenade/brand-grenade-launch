...
export function extractImpossibilityAnalysis(
  ...
  const GENERIC =
    /^(distinctiveness assessment|overview|summary|introduction|assessment|category differentiation|strategic uniqueness|territory claimed|conclusion|verdict|strategic impossibility analysis|impossibility analysis|distinctiveness testing)$/;
