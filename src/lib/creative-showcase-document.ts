...
<div class="movement" style="border-top:none;padding-top:0;">
  ...
  <p>This is the <strong>Full Creative Showcase</strong> for ${esc(x.brandName)}${x.category ? ` · ${esc(x.category)}` : ""}, generated by the Brand Grenade Creative Engine from one approved campaign in a single session. Nothing here is written from outside that session.</p>
