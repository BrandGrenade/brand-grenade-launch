...
/* Brand Grenade design system — void #0A0908 · ash #1C1A18 · paper #EDE8E0
   · smoke #8B8680 · detonation #C81E1E. Two paper tints only, so rules and
   surfaces stay visible on a paper page. */
:root {
  --void: #0A0908; --ash: #1C1A18; --paper: #EDE8E0;
  --smoke: #8B8680; --detonation: #C81E1E;
  --surface: #E1DCD4; --rule: #C2BCB5;
}
...
#toolbar .actions button.close {
  background: transparent; color: var(--smoke); border: 1px solid #2A2724;
}
@media print {
...
.cover {
  ...
  padding: 40pt 0;
  border-bottom: 2pt solid var(--detonation);
  margin-bottom: 32pt;
}
.cover-brand {
  font-family: 'Bebas Neue', Impact, sans-serif;
  font-size: 15pt; letter-spacing: 0.06em;
  color: var(--ash); margin-bottom: 10pt;
}
.cover-label {
  font-size: 9pt; font-weight: 600; letter-spacing: 0.12em;
  color: var(--detonation); text-transform: uppercase; margin-bottom: 24pt;
}
.cover-title {
  font-family: 'Bebas Neue', Impact, sans-serif;
  font-size: 40pt; font-weight: 400; color: var(--ash);
  line-height: 1.02; letter-spacing: 0.01em; margin-bottom: 24pt;
}
...
.part-label {
  font-size: 9pt; font-weight: 600; letter-spacing: 0.12em;
  color: var(--detonation); text-transform: uppercase; margin-bottom: 6pt;
}
.session-time { font-size: 9.5pt; color: var(--smoke); margin-bottom: 12pt; font-style: italic; }
h2 {
  font-size: 15pt; font-weight: 600; color: var(--ash);
  margin-bottom: 12pt; padding-left: 10pt; letter-spacing: -0.01em;
  border-left: 3pt solid var(--detonation); line-height: 1.25;
}
h3 {
  font-size: 11pt; font-weight: 600; color: var(--ash);
  margin-top: 16pt; margin-bottom: 8pt;
}
p { margin-bottom: 10pt; orphans: 3; widows: 3; }
blockquote {
  border-left: 3pt solid var(--detonation);
  padding: 10pt 14pt; margin: 14pt 0;
...
.prop-reveal {
  ...
  border-top: 2pt solid var(--detonation); border-bottom: 2pt solid var(--detonation);
  margin: 40pt 0;
}
.prop-text {
  font-family: 'Bebas Neue', Impact, sans-serif;
  font-size: 34pt; font-weight: 400; color: var(--ash);
  line-height: 1.06; letter-spacing: 0.01em; max-width: 400pt; margin: 0 auto;
}
.prop-rule { width: 40pt; height: 2pt; background: var(--detonation); margin: 20pt auto 0; }
.footer {
  margin-top: 40pt; padding-top: 16pt;
  border-top: 0.5pt solid var(--rule);
  font-size: 9pt; color: var(--smoke); text-align: center;
}
</style>
</head>
<body>
